...
const Squadwe = require('@squadwe/node');
const isDev = process.env.NODE_ENV !== 'production'
// Replace with your API_ACCESS_TOKEN
const API_ACCESS_TOKEN = '';
// Replace with your squadwe host URL
const APP_HOST = isDev ? 'http://localhost:3000' : 'https://app.squadwe.com';
// Replace with your account id
const ACCOUNT_ID = 1;
const SquadweClient = new Squadwe({ config: { host: APP_HOST, apiAccessToken: API_ACCESS_TOKEN } })
const Conversations = SquadweClient.conversations(ACCOUNT_ID)
...
exports.parseSquadweWebhook = functions.https.onRequest((request, response) => {
